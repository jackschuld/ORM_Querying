...
def problem_two(request):
  ...
  for intructor in ordered_instructors:
    print(f'Full Name: {intructor.first_name} {intructor.last_name}\nHire Date: {intructor.hire_date}\n')
  return complete(request)
...
def problem_five(request):
  new_student = Student.objects.create(first_name="Jack", last_name="Schuld", year=2000, gpa=1.0)
...
def problem_six(request):
  # Make sure to set this equal to the primary key of the row you just created!
    Student.objects.filter(id=11).update(gpa=0.5)
